...
<head>
    ...
    <title>Double Face Pressure Sensitive Constructions</title>
...
<h3 style="text-align: center;">Double Face Pressure Sensitive Constructions</h3>
            ...
            <div id="search-form">
                <form action="http://www.technicote.com/datasheet-results.php" method="post">
                    ...
                    <label for="facestock">Carrier:</label>
                    ...
                    <label for="adhesive2">Adhesive (Secondary):</label>
                    <select id="adhesive2DD" name="adhesive2">
                        <option value=""></option>
                        <?php
                        foreach ($adhesive as $value) {
                                echo '<option value="' . $value[id] . '">' . $value[txt] . '</option>';
                    ...
                    <label for="liner2">Release Liner (Secondary):</label>
                    <select id="liner2DD" name="liner2">
                        <option value=""></option>
                        <?php
                        foreach ($liner as $value) {
                                echo '<option value="' . $value[id] . '">' . $value[txt] . '</option>';
