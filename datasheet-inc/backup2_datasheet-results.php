...
// item search from another page (get request)
...
// Russell Field datasheet search    
...
// General Search from all datasheet pages (get request)    
if (isset($_GET['stype'])) {
    $action = $_GET['stype'];
    $search_action = "search";
...
// end General Search if for get request
