...
?>
<form class="fsForm" action="datasheet-results2.php" method="post"> 
    ...
    <div class="ds-data">
        <div class="ds-fs-col1">
            <div class="ds-item">
              ...
              <div class="ds-item-data"><input name="fsType" value="<?php echo $facestock['fpapfm']; ?>"></div>
            </div>
        ...
        <div class="ds-save">
            <input class="ds-save-btn" type="submit" name="post_fs" value="Update">
        </div>
</div>
</form>
