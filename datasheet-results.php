...
<div id="datasheet">
    <div class="ds-head">
        <div><img src="http://www.technicote.com/wp-content/uploads/2018/05/technicote-logo-color.png" alt=""></div>
    ...
    <div class="ds-prod-title-sect">
        ...
        <div><a class="<?php echo ($_GET['print'] == "true" ? "hide" : "") ?>" href="emaildatasheet.php?<?php echo $query_str ?>">Email This Page</a></div>
    </div>
